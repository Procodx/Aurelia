...
export function ThreeStarfield({
  ...
  useEffect(() => {
    ...
    // Cheap, one-time device heuristic (no live FPS monitor needed): fewer
    // logical cores or a narrow viewport usually means a phone or a weaker
    ...
    const positions = new Float32Array(effectiveDensity * 3);
    const colors = new Float32Array(effectiveDensity * 3);
    const colorChoices = [
    ...
    for (let i = 0; i < effectiveDensity; i += 1) {
      const i3 = i * 3;
